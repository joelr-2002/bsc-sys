            ...
            {canManageTwoFactor && (
                <div className="space-y-6">
                    <Heading
                        ...
                        description="Administra tu configuración de autenticación de dos pasos"
                    />
                    {twoFactorEnabled ? (
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Se te pedirá un PIN seguro y aleatorio durante
                                el inicio de sesión, el cual podrás obtener de la
                                aplicación TOTP en tu teléfono.
                            </p>
                        ...
                        <div className="flex flex-col items-start justify-start space-y-4">
                            <p className="text-sm text-muted-foreground">
                                Cuando activas la autenticación de dos pasos,
                                se te pedirá un PIN seguro durante el inicio de sesión.
                                Este PIN se puede obtener en tu aplicación TOTP
                                en tu teléfono.
                            </p>
